...
def ReturnMenu():
    ...
    time.sleep(0.2)
    print(Fore.GREEN + " [5]" + Fore.LIGHTRED_EX + " Help Menu " + "\n")
    time.sleep(0.1)
    print(Fore.GREEN + " [6]" + Fore.LIGHTMAGENTA_EX + " Upgrade Script With Github " + "\n")
    time.sleep(0.2)
    print(Fore.BLUE + " [7]" + Fore.YELLOW + " Quit Script :) ")
...
def helpMenu():
    BannerModule.banner()
    print("")
    os.system("start assets\help.html")
